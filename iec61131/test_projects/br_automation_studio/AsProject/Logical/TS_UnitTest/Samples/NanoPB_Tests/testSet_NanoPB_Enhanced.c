...
/* Test fixtures */
UNITTEST_FIXTURES(nanopb_enhanced_fixtures)
{
...
UNITTEST_CALLER_COMPLETE_EXPLICIT(testSet_NanoPB_Enhanced, "Enhanced nanoPB Tests with Real Proto Files", 
setupTest, teardownTest, nanopb_enhanced_fixtures, 0, 0, 0);